...
This folder, where everything resides that you need for analysis (code & data), is referred to as a Projekt. Working with Projects is exceptionally comfortable with RStudio an integrated development environment (IDE) for R. It is usefull to organize this Project in way that strictly segregates (raw) data and code by placing them in directories called `data` and `R` [see Section 4 @marwickPackagingDataAnalytical2018].
...
Note that this is the intended behavior and the result of a [bugfix](https://bugs.r-project.org/bugzilla/show_bug.cgi?id=17494) implemented from R 3.6.0 upwards.
