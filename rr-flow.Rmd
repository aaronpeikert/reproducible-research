...
R-based data analyses. In this context, reproducibility means to us that scientific results together with their computational scientific workflows are reported fully, transparently and sustainably available, such that the workflow can be re-run by a different person and/or later in time and the results will be identical to the ones intially reported. Here, we combine four tools from the computer sciences, whose interplay can guarantuee full and sustainable computational reproducibility of data analyses. The major four elements are:
