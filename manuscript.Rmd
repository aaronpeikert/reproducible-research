...
The adress to connect to the RStudio server is your IP address (or `localhost` on Linux) in this scheme: `<IPADRESS>:8787`. This offers a fully functioning RStudio instance that runs in the image but is accessible through a local web browser.
