...
```{r source-rmarkdown, eval = TRUE, echo = FALSE,  fig.cap="Exemplary source of an R Markdown showing a combination of executable R code and English manuscript text. Code is either given in separate chucks (grey background delimited by triple backticks) or inline (single backticks). "}
