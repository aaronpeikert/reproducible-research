...
This flexibility to fully control the software environment is of particular interest for software infrastructures where the user cannot install software themself, because of limited rights e.g. on cloud computing platforms or High-Performance Computing Clusters. However, executing docker itself needs special rights which are seldomly granted on High-Performance Computing Cluster. For this case, Singularity provides a fully compatible alternative (see Section under [Linux]).
